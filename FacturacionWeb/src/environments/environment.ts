...
export const environment = {
  stationCode: "BOG",
  production: false,
  facturacionAPI: "https://localhost:44368/facturacion"
};
...
export const b2cPolicies = {
  ...
  authorities: {
    signUpSignIn: {
      authority:
        "https://b2ccargoapps.b2clogin.com/b2ccargoapps.onmicrosoft.com/B2C_1_SingIn_SingUp",
    },
    resetPassword: {
      authority:
...
export const apiConfig: { b2cScopes: string[]; webApi: string } = {
  b2cScopes: [
    "https://b2ccargoapps.onmicrosoft.com/85aea48f-cd1b-48c0-b458-e700ddc9707c/cargodev",
  ],
  webApi:
    "https://b2ccargoapps.onmicrosoft.com/85aea48f-cd1b-48c0-b458-e700ddc9707c/cargodev",
};
...
export const msalConfig: Configuration = {
  auth: {
    clientId: "dd1be1bc-80dc-4d37-a93c-928f9d2698e6",
